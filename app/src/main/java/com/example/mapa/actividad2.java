...
public class actividad2 extends AppCompatActivity implements OnMapReadyCallback, Asynchtask {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map2);mapFragment.getMapAsync(this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraUpdate camUpd1 = CameraUpdateFactory
                .newLatLngZoom(new LatLng(lat, lng), 16);
    ...
    private void updateInterfaz(){
        ...
        WebService ws= new WebService(
                "https://turismo.quevedoenlinea.gob.ec/lugar_turistico/json_getlistadoMapa?lat=-1.0223057&lng=-79.4611302" + lat +   "&lng=" + lng +"&radio=" + (radio/10.0)  ,datos,

                actividad2.this, actividad2.this);
        ws.execute("GET");
